...
function makeBalanceModalStore() {
	...
	const taskTickStore = createStore();
	autoStore.value = 0;
	tickStore.value = 0;
	...
	const useTaskTick = () => {
		return useStoreValue(taskTickStore) ?? 0;
	};
	const bumpTaskTick = () => {
...
function FooterButton({ onOpen, reportSession, wide = false, useSessions, run, useOpen, usePriceTick, useTaskTick }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
				...
				children: [periodGroup, bal !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					className: "dshb-footer-balance",
					children: [curSym !== "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
function HeaderButton({ sessionId, run, useTick, usePriceTick, useSession, useTaskTick, bumpTaskTick }) {
	const tick = useTick();
	const priceTick = usePriceTick?.() ?? 0;
	const taskTick = useTaskTick?.() ?? 0;
	const [tokens, setTokens] = (0, react.useState)(null);
	const [amount, setAmount] = (0, react.useState)(null);
	const running = useSession ? useSession((s) => s.running) : void 0;
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
						...
						return COST_ROWS.map((rowDef, ri) => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [ri === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("td", {
								className: "dshb-cost-key",
								rowSpan: COST_ROWS.length,
								children: [meta.masked !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: "dshb-cost-key-token",
									title: p,
									children: meta.masked
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: "dshb-cost-key-label",
									children: meta.label
								})] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									className: "dshb-cost-key-name",
									title: p,
