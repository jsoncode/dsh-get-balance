...
function makeBalanceModalStore() {
	...
	const showBalanceStore = createStore();
	...
	const useShowBalance = () => {
		return useStoreValue(showBalanceStore) ?? true;
	};
...
function FooterButton({ onOpen, reportSession, wide = false, useSessions, run, useOpen, usePriceTick, useBalanceTick, useShowBalance, useUpdate, onUpdateClick }) {
	...
	const balText = bals === null || bals.length === 0 ? "" : bals.map((seg) => !showBalance ? "**" : seg.ok ? currencySymbol(seg.currency) + seg.total : "--").join(" | ");
				...
				wide ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
					...
					children: [periodGroup, bals !== null && bals.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: bals.map((seg, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [i > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							"aria-hidden": "true",
							children: "|"
						}) : null, !showBalance ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
function BalanceModal({ run, useOpen, close, getSession, useTick, useAutoSeconds, setAutoSeconds, bumpPriceTick, useShowBalance, setShowBalance }) {
	const open = useOpen();
	const tick = useTick();
	const autoSeconds = useAutoSeconds();
	const showBalance = useShowBalance();
	const [tab, setTab] = (0, react.useState)("balance");
	const [pricePlatform, setPricePlatform] = (0, react.useState)("deepseek");
	...
	*/
	...
	const renderBalanceTab = () => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
		/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: "dshb-showbalance-row",
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "dshb-showbalance-text",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: "dshb-showbalance-title",
					children: t("showBalanceToggle")
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					className: "dshb-showbalance-hint",
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: "dshb-switch-thumb" })
			})]
		}),
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										className: "dshb-balance-num",
										children: [
											balanceText(info.total_balance),
											" ",
											info.currency
										]
									})
								...
								children: [
									t("balanceGranted"),
									" ",
									balanceText(info.granted_balance),
	...
	*  未在配置中的路由回退到用量分组的官方标志。 */
	...
	const renderDeepseekPrices = () => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
		className: "dshb-hint",
	...
	*/
	const renderPricesTab = () => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: "dshb-subtabs",
			role: "tablist",
			"aria-label": t("tabPrices"),
			children: PRICE_PLATFORMS.map((p) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				role: "tab",
			...
			className: "dshb-subpanes",
			children: PRICE_PLATFORMS.map((p) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: "dshb-pane" + (pricePlatform === p.key ? "" : " dshb-pane-off"),
				children: platformViews[p.key]()
			}, p.key))
		})] });
	};
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
function createPlugin() {
	return {
		...
		apply(ctx) {
			...
			const { store: modalStore, useOpen, autoStore, tickStore, bumpTick, useTick, useAutoSeconds, usePriceTick, bumpPriceTick, useBalanceTick, bumpBalanceTick, showBalanceStore, useShowBalance, setUpdate, useUpdate, openUpdateConfirm, openUpdateLog, closeUpdateUi, useUpdateUi } = makeBalanceModalStore();
