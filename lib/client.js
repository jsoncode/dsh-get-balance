...
const css = [
	...
	".dshb-header-bd-backdrop{position:fixed;inset:0;z-index:1100}",
...
function HeaderButton({ sessionId, run, useTick, usePriceTick, useSession, bumpBalanceTick }) {
	...
	*/
	...
	}), popoverOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
