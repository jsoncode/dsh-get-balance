...
export function BalanceModal({ run, useOpen, close, getSession, useTick, useAutoSeconds, setAutoSeconds, bumpPriceTick, useShowBalance, setShowBalance }) {
    ...
    return (_jsxs("div", { className: "dshb-backdrop", onClick: (e) => { if (e.target === e.currentTarget)
            close(); }, children: [_jsxs("div", { className: "dshb-modal", role: "dialog", "aria-modal": "true", children: [_jsxs("div", { className: "dshb-modal-header", children: [_jsx("div", { className: "dshb-modal-title", children: t('modalTitle') }), _jsxs("div", { className: "dshb-tabs", children: [_jsx("button", { type: "button", className: 'dshb-tab' + (tab === 'balance' ? ' dshb-tab-active' : ''), onClick: () => setTab('balance'), children: t('tabBalance') }), _jsx("button", { type: "button", className: 'dshb-tab' + (tab === 'cost' ? ' dshb-tab-active' : ''), onClick: () => setTab('cost'), children: t('tabCost') }), _jsx("button", { type: "button", className: 'dshb-tab' + (tab === 'prices' ? ' dshb-tab-active' : ''), onClick: () => setTab('prices'), children: t('tabPrices') })] }), _jsxs("div", { className: "dshb-head-ops", children: [_jsxs("button", { type: "button", className: "dshb-btn dshb-btn-small", onClick: openTimingDialog, children: [t('timingBtn'), autoSeconds > 0 ? '·' + autoSeconds + 's' : ''] }), tab === 'balance'
                ...
                ? (_jsx("div", { className: "dshb-timing-backdrop", onClick: (e) => { if (e.target === e.currentTarget)
                        cancelModelDialog(); }, children: _jsxs("div", { className: "dshb-model-dialog", role: "dialog", "aria-modal": "true", "aria-label": t('modelDialogTitle'), children: [_jsx("div", { className: "dshb-timing-title", children: t('modelDialogTitle') }), _jsx("p", { className: "dshb-hint", children: t('modelDialogHint') }), _jsx("div", { className: "dshb-model-list", children: (prices ?? []).map((tier, i) => (_jsxs("div", { className: "dshb-model-row", children: [_jsxs("div", { className: "dshb-model-row-head", children: [_jsxs("label", { className: "dshb-model-field", children: [_jsx("span", { children: t('priceName') }), _jsx("input", { className: "dshb-input", value: tier.name, placeholder: t('priceName'), onChange: (e) => updatePrice(i, { name: e.target.value }) })] }), _jsxs("label", { className: "dshb-model-field", children: [_jsx("span", { children: t('priceMatch') }), _jsx("input", { className: "dshb-input", value: tier.match, placeholder: t('priceMatch'), title: tier.match === '*' ? t('fallbackHint') : t('modelMatchHint'), onChange: (e) => updatePrice(i, { match: e.target.value }) })] }), _jsx("button", { type: "button", className: "dshb-btn dshb-btn-small dshb-btn-danger dshb-model-del", title: t('deleteModel'), "aria-label": t('deleteModel'), onClick: () => removeTier(i), children: t('delete') })] }), _jsxs("div", { className: "dshb-model-row-rates", children: [_jsx("span", { className: "dshb-model-period dshb-period-off", children: t('pricePeriodOffPeak') }), [['input', t('priceInput')], ['cacheRead', t('priceCacheRead')], ['output', t('rateOutput')]].map(([field, label]) => (_jsxs("label", { className: "dshb-model-rate", children: [_jsx("span", { children: label }), _jsx("input", { className: "dshb-input dshb-num", type: "number", step: "any", min: 0, value: tier.offPeak[field], "aria-label": label + ' · ' + t('pricePeriodOffPeak'), onChange: (e) => updateRate(i, 'offPeak', field, Number(e.target.value) || 0) })] }, 'off-' + field))), _jsx("span", { className: "dshb-model-period dshb-period-peak", children: t('pricePeriodPeak') }), [['input', t('priceInput')], ['cacheRead', t('priceCacheRead')], ['output', t('rateOutput')]].map(([field, label]) => (_jsxs("label", { className: "dshb-model-rate", children: [_jsx("span", { children: label }), _jsx("input", { className: "dshb-input dshb-num", type: "number", step: "any", min: 0, value: tier.peak[field], "aria-label": label + ' · ' + t('pricePeriodPeak'), onChange: (e) => updateRate(i, 'peak', field, Number(e.target.value) || 0) })] }, 'peak-' + field)))] })] }, tier.id))) }), priceMsg !== ''
