...
export function FooterButton({ onOpen, reportSession, wide = false, useSessions, run, useOpen, usePriceTick, useBalanceTick, useUpdate, onUpdateClick }) {
    ...
    return (_jsx("div", { className: 'dshb-footer-group' + (wide ? '' : ' dshb-footer-rail-group'), children: _jsxs("button", { ref: btnRef, type: "button", className: 'dshb-footer-btn' + (wide ? '' : ' dshb-footer-btn-rail'), 
            ...
            title: wide ? undefined : fullLabel, "aria-label": fullLabel, onClick: onOpen, children: [_jsx("img", { src: BALANCE_LOGO_PNG, alt: "", className: "dshb-footer-logo" }), wide
                    ? (_jsxs("span", { className: "dshb-footer-label", children: [periodGroup, bals !== null && bals.length > 0 ? (_jsx("span", { className: "dshb-footer-balance", children: bals.map((seg, i) => (_jsxs(Fragment, { children: [i > 0 ? _jsx("span", { className: "dshb-footer-balance-sep", "aria-hidden": "true", children: "|" }) : null, seg.ok
                                            ? (() => {
