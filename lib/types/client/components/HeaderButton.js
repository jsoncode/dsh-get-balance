...
export function HeaderButton({ sessionId, run, useTick, usePriceTick, useSession, bumpBalanceTick }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("button", { ref: btnRef, type: "button", className: "dshb-header-btn", title: title, "aria-label": title, "aria-expanded": popoverOpen, onClick: togglePopover, children: [_jsx("span", { children: t('headerBtnPrefix') }), ' ', _jsx(NumberRoller, { value: tokens, format: fmtTokens, fallback: "--", className: "dshb-header-tokens" }), _jsx("span", { className: "dshb-header-sep", children: "|" }), _jsxs("span", { className: "dshb-header-amount", children: ["\u2248\u00A5", _jsx(NumberRoller, { value: amount, format: fmtAmount, fallback: "--", className: "dshb-header-amount-num" })] })] }), popoverOpen ? (_jsxs(_Fragment, { children: [_jsx("div", { className: "dshb-header-bd-backdrop", onClick: () => setPopoverOpen(false) }), _jsxs("div", { className: "dshb-header-bd", role: "dialog", "aria-label": t('headerBreakdownTitle'), style: popoverPos !== null ? { top: popoverPos.top, left: popoverPos.left } : undefined, children: [_jsx("div", { className: "dshb-header-bd-title", children: t('headerBreakdownTitle') }), byKey === null || byKey.length === 0
