...
export declare function UpdateDialogs({ run, useUpdate, useUi, closeUi, onConfirm, recheck }: UpdateDialogsProps): import("react").JSX.Element | null;
//# sourceMappingURL=UpdateDialogs.d.ts.map