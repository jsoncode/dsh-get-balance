...
export const css = [
    ...
    '.dshb-price-model-match{display:block;font-size:11px;line-height:1.3;color:var(--dsw-alias-label-tertiary,#888);word-break:break-all}',
    '.dshb-price-actions{display:flex;justify-content:flex-end;margin-top:8px}',
    '.dshb-model-dialog{width:min(760px,94vw);max-height:82vh;display:flex;flex-direction:column;gap:8px;background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#222);border:1px solid var(--dsw-alias-border-l2,#ccc);border-radius:14px;padding:16px;box-shadow:0 18px 48px rgba(0,0,0,.28)}',
    '.dshb-model-actions{display:flex;gap:8px;margin-top:12px;justify-content:flex-end}',
    '.dshb-model-actions .dshb-model-add{margin-right:auto}',
    '.dshb-model-list{flex:1;min-height:0;overflow-y:auto;display:flex;flex-direction:column;gap:8px}',
    '.dshb-model-row{display:flex;flex-direction:column;gap:6px;border:1px solid var(--dsw-alias-border-l2,#ddd);border-radius:10px;padding:8px 10px}',
    '.dshb-model-row-head{display:flex;align-items:flex-end;gap:8px}',
    '.dshb-model-field{display:flex;flex-direction:column;gap:2px;flex:1;min-width:0;font-size:11px;color:var(--dsw-alias-label-secondary,#666)}',
    '.dshb-model-field .dshb-input{padding:5px 8px;font-size:12px;border-radius:6px}',
    '.dshb-model-del{flex:none}',
    '.dshb-model-row-rates{display:flex;align-items:center;gap:8px;flex-wrap:wrap}',
    '.dshb-model-period{font-size:11px;font-weight:500;flex:none}',
    '.dshb-model-rate{display:flex;align-items:center;gap:4px;font-size:11px;color:var(--dsw-alias-label-secondary,#666)}',
    '.dshb-model-rate .dshb-input{width:78px;padding:4px 6px;font-size:12px;border-radius:6px;text-align:center;font-family:ui-monospace,SFMono-Regular,Consolas,monospace}',
].join('\n');
