...
export const css = [
    ...
    '.dshb-model-dialog{width:min(880px,96vw);max-height:82vh;display:flex;flex-direction:column;gap:8px;background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#222);border:1px solid var(--dsw-alias-border-l2,#ccc);border-radius:14px;padding:16px;box-shadow:0 18px 48px rgba(0,0,0,.28)}',
    '.dshb-model-actions{display:flex;gap:8px;margin-top:2px;justify-content:flex-end}',
    '.dshb-model-actions .dshb-model-add{margin-right:auto}',
    '.dshb-model-scroll{flex:1;min-height:0;overflow:auto}',
    '.dshb-model-table{min-width:700px}',
    '.dshb-model-table th,.dshb-model-table td{text-align:center;padding:5px 6px;white-space:nowrap}',
    '.dshb-model-table .dshb-input{width:100%;box-sizing:border-box;padding:5px 8px;font-size:12px;border-radius:6px}',
    '.dshb-model-table .dshb-num{width:100%;text-align:center;font-family:ui-monospace,SFMono-Regular,Consolas,monospace}',
    '.dshb-model-col-name,.dshb-model-col-match{width:150px}',
    '.dshb-model-col-ops{width:64px}',
    '.dshb-model-ops{white-space:nowrap}',
    '.dshb-model-sep{border-left:1px solid var(--dsw-alias-border-l1,#eee)}',
].join('\n');
