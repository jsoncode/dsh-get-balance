...
export const css = [
    ...
    '.dshb-price-head-edit{display:flex;flex-direction:column;gap:3px}',
    '.dshb-price-head-row{display:flex;align-items:center;gap:3px}',
    '.dshb-price-head-edit .dshb-input{padding:3px 6px;font-size:11px;border-radius:5px;text-align:center}',
    '.dshb-price-del{flex:none;padding:3px 6px;line-height:1;font-size:11px}',
    '.dshb-price-actions{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-top:8px}',
    '.dshb-price-actions .dshb-hint{margin:0;flex:1}',
].join('\n');
