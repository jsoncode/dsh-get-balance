...
import { computeSeries, seriesBackfillInfo, SERIES_RANGES } from "./series.js";
import { checkPluginUpdate } from "./update.js";
import { getPluginUpdateStatus, startPluginUpdate } from "./plugin-update.js";
/* ── 配置文件读写（$DSH_HOME/dsh-get-balance.json）────────────── */
/** 读取用户附加 key 列表。 */
export async function readExtraKeys() {
    ...
    try {
        switch (request.op) {
            ...
            case 'costSeries': {
                ...
                if (!SERIES_RANGES.includes(range)) {
