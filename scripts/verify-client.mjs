...
if (!factories.has('dsh-get-balance')) {
  console.error('verify-client FAIL: bundle 未注册 "dsh-get-balance" 工厂')
  process.exit(1)
}
...
const edges = new Set()
const exports = factories.get('dsh-get-balance')(makeRequire(edges))
const mod = exports || {}

const shapeOk = mod.name === 'dsh-get-balance' && typeof mod.apply === 'function' && Array.isArray(mod.inject)
if (!shapeOk) {
