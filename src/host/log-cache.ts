 ...
 */
export const SESSION_LOG_CANDIDATES: Array<{ name: string; zstd: boolean }> = [
  { name: 'session.v3.jsonl.zstd', zstd: true },
  { name: 'session.v3.jsonl', zstd: false },
  { name: 'session.jsonl.zstd', zstd: true },
  { name: 'session.jsonl', zstd: false },
]
